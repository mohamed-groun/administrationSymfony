...
class TacheController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@App/tache/index.html.twig', array(
            'taches' => $taches,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@App/tache/new.html.twig', array(
            'tache' => $tache,
    ...
    public function showAction(Tache $tache)
    {
        ...
        return $this->render('@App/tache/show.html.twig', array(
            'tache' => $tache,
    ...
    public function editAction(Request $request, Tache $tache)
    {
        ...
        return $this->render('@App/tache/edit.html.twig', array(
            'tache' => $tache,
